...
# Create model
#model = SVC(C = 48, kernel = 'rbf', gamma = 'auto', random_state = 0).fit(X_train, y_train)
#model = DecisionTreeClassifier().fit(X_train, y_train)
#model = RandomForestClassifier(n_estimators = 250, max_depth = 42, random_state = 0).fit(X_train, y_train)
...
class_names = ['no retweets', 'some retweets', 'lots of retweets']
fig, ax = plt.subplots()
